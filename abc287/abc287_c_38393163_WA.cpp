/*
 * Author: kAsA02
 * Submission URL: https://atcoder.jp/contests/abc287/submissions/38393163
 * Submitted at: 2023-01-28 12:18:29
...
int main(){
    ...
    if(n==2){
        ...
        if(one==2 && two==n-2 && over==0 && zero==0)cout<< "Yes" << endl;
        else cout<< "No" << endl;
    }
    }
