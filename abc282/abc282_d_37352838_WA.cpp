/*
 * Author: kAsA02
 * Submission URL: https://atcoder.jp/contests/abc282/submissions/37352838
 * Submitted at: 2022-12-17 13:19:57
...
int main(){
      ...
      ans-=((ll)solo.size()*((ll)solo.size()-1))/2;
      cout<< ans << endl;
