/*
 * Author: kAsA02
 * Submission URL: https://atcoder.jp/contests/arc157/submissions/39189997
 * Submitted at: 2023-02-25 12:59:16
...
int main(){
    ...
    if((c==0 && d==0 && a==0) || (d==0 && a==0 && b==0)){
        ...
        if((a==0 && b==0 && c==0) || (b==0 && c==0 && d==0)){
            cout<< "Yes" << endl;
        }else if((a==0 && b==0 && c==1) || (c==0 && d==0 && b==1) ||(a==0 && c==0 && b==1) || (b==0 && c==0 && c==1)){
            cout<< "Yes" << endl;
        }else if(b==0 && c==0){
            cout<< "No" << endl;
