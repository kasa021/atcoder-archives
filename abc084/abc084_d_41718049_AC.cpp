/*
 * Author: kAsA02
 * Submission URL: https://atcoder.jp/contests/abc084/submissions/41718049
 * Submitted at: 2023-05-27 05:27:09
...
int main() {
    ...
    rep(i,q){
		...
		if(index_l==-1) index_l = similar_primes.size();
		rep(j,similar_primes.size()){
		...
		if(index_r==-1) index_r = similar_primes.size();
