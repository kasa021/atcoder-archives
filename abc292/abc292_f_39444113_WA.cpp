/*
 * Author: kAsA02
 * Submission URL: https://atcoder.jp/contests/abc292/submissions/39444113
 * Submitted at: 2023-03-04 13:40:40
...
double fun(double a,double si){
    return a*cos(si)*cos(M_PI/6-si);
}
int main()
{
    double c,d;
    cin>>c>>d;
    double a=max(c,d),b=min(c,d);
    if(b>=2*a*tan(M_PI/6)){
