/*
 * Author: kAsA02
 * Submission URL: https://atcoder.jp/contests/arc157/submissions/39196785
 * Submitted at: 2023-02-25 13:44:38
...
int main(){
    ...
    if(n==4){
        if(a==3 ||(a==2&&b==1) || (a==1 && b==1 &&c==1)||(a==1 && b==1 && d==1) || (b==2 && c==1) || (a==1 && b==1 && c==1) || (b==1 && d==2) || (b==1 && c==1 && d==1) || (c==2 && b==1)){
            cout<< "Yes" << endl;
        }else cout<< "No" << endl;
        return 0;
    }
