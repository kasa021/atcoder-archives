/*
 * Author: kAsA02
 * Submission URL: https://atcoder.jp/contests/abc282/submissions/37359126
 * Submitted at: 2022-12-17 13:50:13
...
int main(){
     ...
     ll ans=(n*(n-1))/2-m;
      ...
      ans-=((ll)white.size()*((ll)white.size()-1))/2ll;
      ans-=((ll)black.size()*((ll)black.size()-1))/2ll;
